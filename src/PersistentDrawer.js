...
// import DepartIntro from './NavMenu';
        ...
        return (
            ...
            <div className={classes.appFrame}>
                <AppBar className={classNames(classes.appBar, {[classes.appBarShift]: open, [classes[`appBarShift-${anchor}`]]: open,})}>
                    <Toolbar disableGutters={!open}>
                        <IconButton color="inherit" aria-lable="open drawer" onClick={this.handleDrawerOpen} className={classNames(classes.menuButton, open && classes.hide)}>
                            <MenuIcon/>
                        </IconButton>
                        <Typography variant="title" color="inherit" noWrap>
                            行政部
                ...
                >
                    <div className={classes.drawerHeader} />
                    <Typography noWrap>{'欢迎来到行政部大家庭'}</Typography>
                </main>
                {after}
            </div>
            </div>
